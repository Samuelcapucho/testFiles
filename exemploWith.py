...
with ZipFile('https://github.com/Samuelcapucho/testFiles/blob/main/intermedio.zip', 'w') as myzip:
    myzip.writestr('protocolo.pdf', st.session_state["arquivoObject"])


with ZipFile('https://github.com/Samuelcapucho/testFiles/blob/main/intermedio.zip', 'r') as myzipTwo:
